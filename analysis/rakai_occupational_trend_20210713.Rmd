...
dat <- read_dta("../data/all_data_original_id_1_19.dta")
dat_part_cleaned <- read_dta("../data/R1_R18_partcleaned_incidence_20190913.dta")
...
**Generate a word cloud for occupations described in `Other`**
